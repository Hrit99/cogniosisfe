        ...
        Positioned(
          ...
          child: Container(
            ...
            child: ClipRect(
              child: Align(
                alignment: Alignment
                    .topLeft, // Ensures alignment to the top-left corner
                widthFactor: 0, // Use 1 to match the container's width
                heightFactor: 0, // Crop height as intended
                child: Transform.translate(
                  offset:
                      Offset(-getWidth(context, 130), getHeight(context, 0)),
                  child: Transform.scale(
                    scale: 1, // Scale video to fill cropped area
      ...
      children: [
        Container(
          ...
          width: MediaQuery.of(context)
              .size
              .width, // Extend the width to stretch the video
          child: VideoPlayer(videoController),
        ),
      ],
    );
